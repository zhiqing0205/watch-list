...
import { Star, Clock, Calendar, Play, Users, ArrowLeft, Tv } from 'lucide-react'
...
export function TvDetailContent({ tvData }: TvDetailContentProps) {
  const { tvShow, similarTvShows, hasMoreSimilarTvShows } = tvData
